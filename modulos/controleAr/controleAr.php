    ...
    <body class="corClara" onbeforeunload="return mudaTema(0)"> <!-- ao sair retorna os background claros -->
        ...
        <div id="tricoluna0" style="margin: 20px; border: 2px solid blue; border-radius: 15px; padding: 20px; min-height: 200px;">
            ...
            <div id="tricoluna3" class="box" style="position: relative; float: left; width: 33%; text-align: left;">
                ...
                <button class="botpadrred" style="padding-left: 5px; padding-right: 5px;" id="botimpr" onclick="imprAr();">PDF</button>
            </div>
                ...
                <div id="relacmodalInsCorret" style="display: none;">
                    <table style="margin: 0 auto; width: 90%;">
                        <tr>
                            ...
                            <td colspan="3">
<!--                                <select id="empresaCorret" onchange="modif();" style="font-size: 1rem; width: 100%;" title="Selecione uma empresa."> </select> -->
