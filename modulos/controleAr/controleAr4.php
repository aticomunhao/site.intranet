        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                if(parseInt(document.getElementById("guardaInsArCond").value) === 1 || parseInt(document.getElementById("guardaFiscArCond").value) === 1 || parseInt(document.getElementById("UsuAdm").value) > 6){
                    $("#faixacentral").load("modulos/controleAr/relAr4.php?acao=todos&ano="+document.getElementById("selectAno").value);
            ...
            function carregaEmpresas(){
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=buscarelempresas", true);
...
//alert(ajax.responseText);
            ...
            function insAparelho(){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=buscanumero", true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
            ...
            function salvaModal(){
                if(document.getElementById("mudou").value != "0"){
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=salvadados&codigo="+document.getElementById("guardaid").value
...
//alert(ajax.responseText);
            ...
            function buscaData(Cod, InsEdit){ // Cod é o id de visitas_ar4 - O guardaid fica com o id de controle_ar4 pq vem do click na linha DataTable
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=buscadata&codigo="+Cod, true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
                                Resp = eval("(" + ajax.responseText + ")");  //Lê o array que vem
                                if(parseInt(Resp.coderro) === 0){
                                    document.getElementById("guardaid").value = Resp.cod;// id de visitas_ar4 para editar
            ...
            //Vem de relAr4.php - insere visita preventiva ou corretiva
            function insereData(Cod, InsEdit){ // Cod é o id de controle_ar4 - busca dados do aparelho
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=buscadados&codigo="+Cod, true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
            ...
            function salvaDataInsPrevent(){
                if(document.getElementById("mudou").value != "0"){
                    ...
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=salvadatainsprevent&codigo="+document.getElementById("guardaid").value
...
//alert(ajax.responseText);
            ...
            function salvaDataInsCorret(){ // OK
                if(document.getElementById("mudou").value != "0"){
                    ...
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=salvamanutcorret&codigo="+document.getElementById("guardaid").value
...
//alert(ajax.responseText);
            ...
            function editaLocal(Cod){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=buscalocal&codigo="+Cod, true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
            ...
            function salvaLocal(){
                if(document.getElementById("mudou").value != "0"){
                        ajaxIni();
                        if(ajax){
                            ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=salvalocal&codigo="+document.getElementById("guardaid").value
                ...
                $.confirm({
                    ...
                    buttons: {
                        Sim: function () {
                            ajaxIni();
                            if(ajax){
                                ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=apagadata&codigo="+document.getElementById("guardaid").value, true);
                                ajax.onreadystatechange = function(){
                                    if(ajax.readyState === 4 ){
                                        if(ajax.responseText){
//alert(ajax.responseText);
            ...
            function editaEmpresa(Cod){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=buscaempresa&codigo="+Cod, true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
            ...
            function salvaEditEmpr(){
                if(document.getElementById("mudou").value != "0"){
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/controleAr/salvaControle4.php?acao=salvanomeempresa&codigo="+document.getElementById("guardaCodEmpr").value 
...
//alert(ajax.responseText);
            ...
            function imprAr(){
                if(parseInt(document.getElementById("selectAno").value) != ""){
                    window.open("modulos/controleAr/imprListaAr4.php?acao=listamesManut&colec=3&ano="+document.getElementById("selectAno").value, "colec3");
                }
            }
    ...
    <body class="corClara" onbeforeunload="return mudaTema(0)"> <!-- ao sair retorna os background claros -->
        ...
        $rsSis = pg_query($Conec, "SELECT column_name FROM INFORMATION_SCHEMA.COLUMNS WHERE table_schema = 'cesb' And TABLE_NAME = 'controle_ar4'");
        $rowSis = pg_num_rows($rsSis);
        if($rowSis == 0){
            pg_query($Conec, "CREATE TABLE IF NOT EXISTS ".$xProj.".controle_ar4 (
        ...
        $rsSis = pg_query($Conec, "SELECT column_name FROM INFORMATION_SCHEMA.COLUMNS WHERE table_schema = 'cesb' And TABLE_NAME = 'visitas_ar4'");
        $rowSis = pg_num_rows($rsSis);
        if($rowSis == 0){
            pg_query($Conec, "CREATE TABLE IF NOT EXISTS ".$xProj.".visitas_ar4 (
            id SERIAL PRIMARY KEY, 
        ...
        $rsAno = pg_query($Conec, "SELECT DISTINCT to_char(datavis, 'YYYY') FROM ".$xProj.".visitas_ar4 WHERE ativo = 1");
        $AnoIni = date("Y");
        $Hoje = date("d/m/Y");
        $Data = date("d/m/Y H:i");
