...
//    $pdf->Cell(0, 5, $Cabec2, 0, 2, 'C');
    ...
    if($Acao == "listamesManut"){
        ...
        $rs0 = pg_query($Conec, "SELECT id, num_ap, localap, empresa_id FROM ".$xProj.".controle_ar2 WHERE num_ap IS NOT NULL And ativo = 1 ORDER BY num_ap");
        ...
        if($row0 > 0){
            ...
            while($tbl0 = pg_fetch_row($rs0)){
                ...
                $rs1 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '01' ORDER BY datavis DESC");
                ...
                $rs3 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '03' ORDER BY datavis DESC");
                ...
                $rs4 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '04' ORDER BY datavis DESC");
                ...
                $rs5 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '05' ORDER BY datavis DESC");
                ...
                $rs6 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '06' ORDER BY datavis DESC");
                ...
                $rs7 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '07' ORDER BY datavis DESC");
                ...
                $rs8 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '08' ORDER BY datavis DESC");
                ...
                $rs9 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '09' ORDER BY datavis DESC");
                ...
                $rs10 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '10' ORDER BY datavis DESC");
                ...
                $rs11 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '11' ORDER BY datavis DESC");
                ...
                $rs12 = pg_query($Conec, "SELECT to_char(datavis, 'DD'), to_char(datavis, 'MM'), tipovis FROM ".$xProj.".visitas_ar2 WHERE controle_id = $Cod And ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And DATE_PART('MONTH', datavis) = '12' ORDER BY datavis DESC");
            ...
            $rs1 = pg_query($Conec, "SELECT id FROM ".$xProj.".visitas_ar2 WHERE ativo = 1 And DATE_PART('YEAR', datavis) = '$Ano' And tipovis = 2");
            $row1 = pg_num_rows($rs1);
            $pdf->SetX(50);
