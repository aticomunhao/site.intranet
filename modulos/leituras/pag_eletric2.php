        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                if(parseInt(document.getElementById("guardaerro").value) === 0){
                    ...
                    $('#carregaTema').load('modulos/config/carTema.php?carpag=eletric2');
...
//alert(ajax.responseText);
                ...
                $("#selecVisuMesAnoEletric").change(function(){
                    ...
                    $("#container5").load("modulos/leituras/carEletric2.php?mesano="+encodeURIComponent(document.getElementById("selecVisuMesAnoEletric").value));
                    $("#container6").load("modulos/leituras/carEstatEletric2.php?mesano="+encodeURIComponent(document.getElementById("selecVisuMesAnoEletric").value)+"&corTema="+document.getElementById("guardaCor").value);
                });
                $("#selecVisuAnoEletric").change(function(){
                    document.getElementById("selecVisuMesAnoEletric").value = "";
                    $("#container6").load("modulos/leituras/carEstatEletric2.php?ano="+encodeURIComponent(document.getElementById("selecVisuAnoEletric").value)+"&corTema="+document.getElementById("guardaCor").value);
                });
...
//alert(ajax.responseText);
                                ...
                                if(parseInt(Resp.coderro) === 1){
                                    ...
                                    $("#container5").load("modulos/leituras/carEletric2.php");
                                    $("#container6").load("modulos/leituras/carEstatEletric2.php?corTema="+document.getElementById("guardaCor").value);
                                    document.getElementById("relacmodalEletric").style.display = "none";
                                }
                            }
                        }
...
//                $("#divgrafico").load("modulos/leituras/grafEletrJs2.php");
    ...
    <body class="corClara" onbeforeunload="return mudaTema(0)"> <!-- ao sair retorna os background claros -->
        <?php
            ...
            $OpcoesVisuMes = pg_query($Conec, "SELECT CONCAT(TO_CHAR(dataleitura2, 'MM'), '/', TO_CHAR(dataleitura2, 'YYYY')) 
            FROM ".$xProj.".leitura_eletric WHERE colec = 2 GROUP BY TO_CHAR(dataleitura2, 'MM'), TO_CHAR(dataleitura2, 'YYYY') ORDER BY TO_CHAR(dataleitura2, 'YYYY') DESC, TO_CHAR(dataleitura2, 'MM') DESC ");
            $OpcoesVisuAno = pg_query($Conec, "SELECT TO_CHAR(dataleitura2, 'YYYY') 
            FROM ".$xProj.".leitura_eletric WHERE colec = 2 GROUP BY TO_CHAR(dataleitura2, 'YYYY') ORDER BY TO_CHAR(dataleitura2, 'YYYY') DESC");
        ...
        <div style="margin: 5px; border: 2px solid green; border-radius: 15px; padding: 5px;">
            <div id="tricoluna0" class="row" style="margin-left: 5px; margin-right: 5px;"> <!-- botões Inserir e Imprimir-->
                ...
                <div id="tricoluna2" style="width: 25%; text-align: center;">Controle do Consumo de Energia Elétrica<?php echo " - ".$Menu2; ?></div> <!-- espaçamento entre colunas  -->
                <div id="tricoluna3" class="col" style="margin: 0 auto; text-align: center;">
                    ...
                    <label styke="padding-right: 10px;"></label>
        ...
        <div id="relacgrafico" class="relacmodal">
            <div class="modal-content-grafico">
                ...
                <h5 id="titulomodal" style="text-align: center;color: #666;">Controle do Consumo de Eletricidade - <?php echo $Menu2; ?></h5>
