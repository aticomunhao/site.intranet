...
<html lang="pt-br">
    ...
    <body> 
        <div style="position: absolute; top: 7px; text-align: left;"><button class="resetbot" onclick="insereModal();">Inserir</button></div>
        <div  style="text-align: center;"><label class="titRelat">Leituras Hidrômetro<label></div>
            <?php 
                ...
                $rs0 = pg_query($Conec, "SELECT id, TO_CHAR(dataleitura, 'DD/MM/YYYY'), date_part('dow', dataleitura), leitura1, leitura2, leitura3, dataleitura FROM ".$xProj.".leituras WHERE controle = 1 And ativo = 1 ORDER BY dataleitura DESC ");
...
//                                if($DataLinha == $DataIni){  //2024-03-01
