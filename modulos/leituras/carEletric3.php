                    ...
                    <tbody>
                        <?php
                            while($tbl0 = pg_fetch_row($rs0)){
                                ...
                                //Preenche coluna consdiario3 para o gráfico
        ...
        <div id="relacmodalEletric" class="relacmodal">
            <div class="modal-content-Eletric corPreta">
                ...
                <table style="margin: 0 auto; width: 95%;">
                    ...
                    <tr>
                        <td><input type="text" style="text-align: center; border: 1px solid; border-radius: 4px;" id="insdata" width="150" onchange="checaData();" placeholder="Data" onkeypress="if(event.keyCode===13){javascript:foco('insleitura3');return false;}"/></td>
                        <td style="text-align: center;"><label id="insdiasemana" style="font-size: 80%;"></label></td>
                        <td style="width: 120px;"><input type="text" style="text-align: center; width: 100%;" id="insleitura3" onchange="modif();" placeholder="Leitura" onkeypress="if(event.keyCode===13){javascript:foco('botsalvar');return false;}"/></td>
                    </tr>
                    <tr>
