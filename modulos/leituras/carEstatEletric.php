...
<html lang="pt-br">
    ...
    <body>
        <div style="text-align: center;"><label class="titRelat">Controle do Consumo de Eletricidade<label></div>
        <?php
        $mes_extenso = array(
            '1' => 'Janeiro',
            '2' => 'Fevereiro',
        ...
        if($row1 > 0){
            while($tbl1 = pg_fetch_row($rs1) ){
                ...
                $rs2 = pg_query($Conec, "SELECT dataleitura, leitura1 FROM ".$xProj.".leitura_eletric WHERE DATE_PART('MONTH', dataleitura) = $Mes And ativo = 1 And leitura1 != 0 ");
