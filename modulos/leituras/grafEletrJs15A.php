...
<html lang="pt-BR">
    ...
    <body>
        ...
        WHERE colec = 1 And dataleitura1 IS NOT NULL And leitura1 != 0 And ativo = 1 And DATE_PART('MONTH', dataleitura1) = $MesAtual And DATE_PART('YEAR', dataleitura1) = $AnoAtual");
        ...
        $datax1 = [];
        $row1 = 0;
        $rs1 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura1), DATE_PART('YEAR', dataleitura1), SUM(consdiario1) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 1 And dataleitura1 IS NOT NULL And leitura1 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura1) = $AnoAtual 
        GROUP BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1) ORDER BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1)");
        ...
        $datax2 = [];
        $row2 = 0;
        $rs2 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura1), DATE_PART('YEAR', dataleitura1), SUM(consdiario1) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 1 And dataleitura1 IS NOT NULL And leitura1 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura1) = ($AnoAtual-1) 
        GROUP BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1) ORDER BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1)");
        ...
        $datax3 = [];
        $row3 = 0;
        $rs3 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura1), DATE_PART('YEAR', dataleitura1), SUM(consdiario1) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 1 And dataleitura1 IS NOT NULL And leitura1 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura1) = ($AnoAtual-2) 
        GROUP BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1) ORDER BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1)");
        ...
        $datax4 = [];
        $row4 = 0;
        $rs4 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura1), DATE_PART('YEAR', dataleitura1), SUM(consdiario1) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 1 And dataleitura1 IS NOT NULL And leitura1 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura1) = ($AnoAtual-3) 
        GROUP BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1) ORDER BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1)");
        ...
        $datax5 = [];
        $row5 = 0;
        $rs5 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura1), DATE_PART('YEAR', dataleitura1), SUM(consdiario1) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 1 And dataleitura1 IS NOT NULL And leitura1 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura1) = ($AnoAtual-4) 
        GROUP BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1) ORDER BY DATE_PART('YEAR', dataleitura1), DATE_PART('MONTH', dataleitura1)");
