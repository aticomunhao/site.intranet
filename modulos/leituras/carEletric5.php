...
//            if($ValorIni == 0 || is_null($DataIni)){
            ...
            $rs0 = pg_query($Conec, "SELECT id, TO_CHAR(dataleitura5, 'DD/MM/YYYY'), date_part('dow', dataleitura5), leitura5, dataleitura5 FROM ".$xProj.".leitura_eletric WHERE colec = 5 And ativo = 1 ORDER BY dataleitura5 DESC ");
            $Cont = 0;
            $Leit24Ant = 0;
            ?>
            <div  style="text-align: center;"><label class="titRelat">Leituras Medidor Eletricidade - Viaturas<label></div>
...
//echo $DataLinha." ".$tbl0[3]." ".$Leit24Ant."<br>";
                                $Leit07 = $tbl0[3];
                                if($Leit07 == 0){
                                    $Cons1 = 0;
                                }else{
