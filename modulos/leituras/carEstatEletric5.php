...
<html lang="pt-br">
    ...
    <body>
        <div style="text-align: center;"><label class="titRelat corPreta">Controle do Consumo de Eletricidade - Viaturas<label></div>
        <?php
        $mes_extenso = array(
            '01' => 'Janeiro',
            '02' => 'Fevereiro',
...
//        if($ValorIni == 0 || is_null($DataIni)){
        ...
        if(isset($_REQUEST["mesano"])){
            ...
            if($MesAno != ""){
                ...
                $Ano = $Proc[1];
                $Condic = "colec = 5 And dataleitura5 IS NOT NULL And leitura5 != 0 And ativo = 1 And DATE_PART('MONTH', dataleitura5) = '$Mes' And DATE_PART('YEAR', dataleitura5) = '$Ano'";
            }else{
                $Condic = "colec = 5 And dataleitura5 IS NOT NULL And leitura5 != 0 And ativo = 1";
            }
        }
        if(isset($_REQUEST["ano"])){
            ...
            if($Ano != ""){
                $Condic = "colec = 5 And dataleitura5 IS NOT NULL And leitura5 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura5) = '$Ano'";
            }else{
                $Condic = "colec = 5 And dataleitura5 IS NOT NULL And leitura5 != 0 And ativo = 1";
            }
        }
