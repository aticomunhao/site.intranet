...
<html lang="pt-BR">
    ...
    <body>
        ...
        $datax1 = [];
        $row1 = 0;
        $rs1 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura5), DATE_PART('YEAR', dataleitura5), SUM(consdiario5) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 5 And dataleitura5 IS NOT NULL And leitura5 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura5) = $AnoAtual 
        GROUP BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5) ORDER BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5)");
        ...
        $datax2 = [];
        $row2 = 0;
        $rs2 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura5), DATE_PART('YEAR', dataleitura5), SUM(consdiario5) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 5 And dataleitura5 IS NOT NULL And leitura5 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura5) = ($AnoAtual-1) 
        GROUP BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5) ORDER BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5)");
        ...
        $datax3 = [];
        $row3 = 0;
        $rs3 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura5), DATE_PART('YEAR', dataleitura5), SUM(consdiario5) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 5 And dataleitura5 IS NOT NULL And leitura5 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura5) = ($AnoAtual-2) 
        GROUP BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5) ORDER BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5)");
        ...
        $datax4 = [];
        $row4 = 0;
        $rs4 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura5), DATE_PART('YEAR', dataleitura5), SUM(consdiario5) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 5 And dataleitura5 IS NOT NULL And leitura5 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura5) = ($AnoAtual-3) 
        GROUP BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5) ORDER BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5)");
        ...
        $datax5 = [];
        $row5 = 0;
        $rs5 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura5), DATE_PART('YEAR', dataleitura5), SUM(consdiario5) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 5 And dataleitura5 IS NOT NULL And leitura5 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura5) = ($AnoAtual-4) 
        GROUP BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5) ORDER BY DATE_PART('YEAR', dataleitura5), DATE_PART('MONTH', dataleitura5)");
