...
<html lang="pt-BR">
    ...
    <body>
        ...
        WHERE colec = 2 And dataleitura2 IS NOT NULL And leitura2 != 0 And ativo = 1 And DATE_PART('MONTH', dataleitura2) = $MesAtual And DATE_PART('YEAR', dataleitura2) = $AnoAtual");
        ...
        $datax1 = [];
        $row1 = 0;
        $rs1 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura2), DATE_PART('YEAR', dataleitura2), SUM(consdiario2) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 2 And dataleitura2 IS NOT NULL And leitura2 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura2) = $AnoAtual 
        GROUP BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2) ORDER BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2)");
        ...
        $datax2 = [];
        $row2 = 0;
        $rs2 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura2), DATE_PART('YEAR', dataleitura2), SUM(consdiario2) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 2 And dataleitura2 IS NOT NULL And leitura2 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura2) = ($AnoAtual-1) 
        GROUP BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2) ORDER BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2)");
        ...
        $datax3 = [];
        $row3 = 0;
        $rs3 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura2), DATE_PART('YEAR', dataleitura2), SUM(consdiario2) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 2 And dataleitura2 IS NOT NULL And leitura2 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura2) = ($AnoAtual-2) 
        GROUP BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2) ORDER BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2)");
        ...
        $datax4 = [];
        $row4 = 0;
        $rs4 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura2), DATE_PART('YEAR', dataleitura2), SUM(consdiario2) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 2 And dataleitura2 IS NOT NULL And leitura2 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura2) = ($AnoAtual-3) 
        GROUP BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2) ORDER BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2)");
        ...
        $datax5 = [];
        $row5 = 0;
        $rs5 = pg_query($Conec, "SELECT DATE_PART('MONTH', dataleitura2), DATE_PART('YEAR', dataleitura2), SUM(consdiario2) 
        FROM ".$xProj.".leitura_eletric 
        WHERE colec = 2 And dataleitura2 IS NOT NULL And leitura2 != 0 And ativo = 1 And DATE_PART('YEAR', dataleitura2) = ($AnoAtual-4) 
        GROUP BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2) ORDER BY DATE_PART('YEAR', dataleitura2), DATE_PART('MONTH', dataleitura2)");
