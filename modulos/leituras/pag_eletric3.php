...
//alert(ajax.responseText);
                                ...
                                if(parseInt(Resp.coderro) === 1){
                                    ...
                                    document.getElementById("guardaUltLeitura").value = Resp.leitura3;
            ...
            function salvaModal(){
                ...
                if(parseInt(document.getElementById("insleitura3").value) < parseInt(document.getElementById("guardaUltLeitura").value)){
                    $('#mensagemLeitura').fadeIn("slow");
...
//                $("#divgrafico").load("modulos/leituras/grafEletrJs3.php");
                $("#divgrafico").load("modulos/leituras/grafEletrJs35A.php");
    ...
    <body class="corClara" onbeforeunload="return mudaTema(0)"> <!-- ao sair retorna os background claros -->
        ...
        <div style="margin: 5px; border: 2px solid green; border-radius: 15px; padding: 5px;">
            <div id="tricoluna0" class="row" style="margin-left: 5px; margin-right: 5px;"> <!-- botões Inserir e Imprimir-->
                ...
                <div id="tricoluna2" style="width: 25%; text-align: center;">Controle do Consumo de Energia Elétrica<?php echo " - ".$Menu3; ?></div> <!-- espaçamento entre colunas  -->
        ...
        <div id="relacimprLeituraEletric" class="relacmodal">
            <div class="modal-content-imprLeitura corPreta">
                ...
                <h5 style="text-align: center;color: #666;">Controle do Consumo de Eletricidade - Oi</h5>
