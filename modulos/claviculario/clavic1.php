...
//Claviculário Portaria:  (fisc_clav)	gerenciar, editar e agendar as chaves do claviculário da Portaria
//                        (clav_edit)	editar, inserir e apagar chaves do claviculário da Portaria
//Claviculário Portaria:  (clav)	    registrar a entrega e devolução das chaves do claviculário na Portaria 
//Claviculário Portaria:  (chave)	    usuário autorizado a retirar chaves do claviculário da Portaria
//
//
//          (clav_edit)	 editar, inserir e apagar chaves do claviculário da Portaria
//Portaria: (fisc_clav)  gerenciar, editar e agendar as chaves do claviculário da Portaria
//Portaria: (clav)       registrar a entrega e devolução das chaves do claviculário na Portaria
//Usuário 	(chave)      usuário autorizado a retirar chaves do claviculário da Portaria
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $("#selecSolicitante").change(function(){
                    ...
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=buscalog&codigo="+document.getElementById("selecSolicitante").value+"&codChave="+document.getElementById("guardaCod").value, true);
...
//alert(ajax.responseText);
                                    ...
                                    if(parseInt(Resp.coderro) === 0){
                                        ...
                                        if(parseInt(Resp.chaveautorizada) === 0){
                                            document.getElementById("msgInfo2").innerHTML = "Usuário não está vinculado à chave "+document.getElementById("sainumchave").value;
                                            document.getElementById("msgInfo3").innerHTML = "O vínculo é feito pela DAF/ATI.";
                                            document.getElementById("msgInfo5").innerHTML = "";
                                        ...
                                        if(parseInt(Resp.chaveautorizada) === 1 && parseInt(Resp.campoHoje) === 0 && parseInt(Resp.somadias) > 0){ // tem algum dia da semana marcado
                                            ...
                                            document.getElementById("msgInfo5").innerHTML = "Chave "+document.getElementById("sainumchave").value;
                ...
                $("#cpfsolicitante").change(function(){
                    ...
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=buscacpf&cpf="+encodeURIComponent(document.getElementById("cpfsolicitante").value)+"&codChave="+document.getElementById("guardaCod").value, true);
                        ajax.onreadystatechange = function(){
                            if(ajax.readyState === 4 ){
                                if(ajax.responseText){
//alert(ajax.responseText);
...
//alert(ajax.responseText);
                ...
                $("#cpfentregador").change(function(){
                    ...
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=buscacpfentregador&cpf="+encodeURIComponent(document.getElementById("cpfentregador").value), true);
                        ajax.onreadystatechange = function(){
                            if(ajax.readyState === 4 ){
                                if(ajax.responseText){
//alert(ajax.responseText);
                                    ...
                                    if(parseInt(Resp.coderro) === 3){ // está em poslog mas não está autorizado a retirar chaves
                                        document.getElementById("voltasolicitante").value = Resp.nomecompl;
                                        document.getElementById("guardaCPF").value = Resp.cpf;
                                        document.getElementById("voltacpf").innerHTML = format_CnpjCpf(Resp.cpf);
                                        document.getElementById("voltasetor").innerHTML = Resp.siglasetor;
                ...
                $("#agendaselecSolicitante").change(function(){
                    ...
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=buscalog&codigo="+document.getElementById("agendaselecSolicitante").value+"&codChave="+document.getElementById("guardaCod").value, true);
                        ajax.onreadystatechange = function(){
                            if(ajax.readyState === 4 ){
                                if(ajax.responseText){
//alert(ajax.responseText);
                ...
                $("#agendacpfsolicitante").change(function(){
                    ...
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=buscacpf&cpf="+encodeURIComponent(document.getElementById("agendacpfsolicitante").value)+"&codChave="+document.getElementById("guardaCod").value, true);
                        ajax.onreadystatechange = function(){
                            if(ajax.readyState === 4 ){
                                if(ajax.responseText){
//alert(ajax.responseText);
...
//                                            }
                ...
                $("#imprRelChave").click(function(){
                    ...
                    window.open("modulos/claviculario/imprChave1.php?acao=relac", "RelacChavesPort");
                });

                $("#selecMesAno").change(function(){
                    document.getElementById("selecAno").value = "";
                    if(document.getElementById("selecMesAno").value != ""){
                        window.open("modulos/claviculario/imprChave1.php?acao=listamesChaves&mesano="+encodeURIComponent(document.getElementById("selecMesAno").value), "Mes"+document.getElementById("selecMesAno").value);
                        document.getElementById("selecMesAno").value = "";
                ...
                $("#selecAno").change(function(){
                    ...
                    if(document.getElementById("selecAno").value != ""){
                        window.open("modulos/claviculario/imprChave1.php?acao=listaanoChaves&ano="+encodeURIComponent(document.getElementById("selecAno").value), "Ano"+document.getElementById("selecAno").value);
                        document.getElementById("selecAno").value = "";
                        document.getElementById("relacimprChaves").style.display = "none";
                    }
                });
                ...
                $("#selecMesAnoMov").change(function(){
                    ...
                    if(document.getElementById("selecMesAnoMov").value != ""){
                        window.open("modulos/claviculario/imprChave1.php?acao=listamesChavesSoMovimentados&mesano="+encodeURIComponent(document.getElementById("selecMesAnoMov").value), "MesMov"+document.getElementById("selecMesAnoMov").value);
                ...
                $("#selecAnoMov").change(function(){
                    ...
                    if(document.getElementById("selecAnoMov").value != ""){
                        window.open("modulos/claviculario/imprChave1.php?acao=listaanoChavesSoMovimentados&ano="+encodeURIComponent(document.getElementById("selecAnoMov").value), "AnoMov"+document.getElementById("selecAnoMov").value);
                        document.getElementById("selecAnoMov").value = "";
                        document.getElementById("relacimprChaves").style.display = "none";
                    }
                });
                ...
                $.confirm({
                    ...
                    buttons: {
                        Sim: function () {
                            ajaxIni();
                            if(ajax){
                                ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=apagaChave&codigo="+document.getElementById("guardaCod").value, true);
                                ajax.onreadystatechange = function(){
                                    if(ajax.readyState === 4 ){
                                        if(ajax.responseText){
//alert(ajax.responseText);
                                                ...
                                                $.confirm({
                                                    ...
                                                    buttons: {
                                                        Sim: function () {
                                                            ajaxIni();
                                                            if(ajax){
                                                                ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=apagaChave_ctl&codigo="+document.getElementById("guardaCod").value, true);
                                                                ajax.onreadystatechange = function(){
                                                                    if(ajax.readyState === 4 ){
                                                                        if(ajax.responseText){
//alert(ajax.responseText);
...
//alert(ajax.responseText);
            ...
            function saidaChaveSemanal(CodAut, CodChave, CodUsu){ // id de chaves
                document.getElementById("botagenda1").style.visibility = "hidden";
                document.getElementById("guardaCod").value = CodChave;
                document.getElementById("CodidChave").value = CodChave;
                document.getElementById("guardaPosCod").value = CodUsu;
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=buscaChaveSemanal&codigo="+CodChave
                    +"&codusu="+CodUsu
                    , true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
...
//alert(ajax.responseText);
            ...
            function marcaChaveInd(Obj, Cod){
                ...
                if(ajax){
                    ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=marcaChaveUsuario&param="+Valor+"&codigo="+Cod+"&usuario="+document.getElementById("configselecSolicitante").value, true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
...
//alert(ajax.responseText);
                                ...
                                if(parseInt(Resp.coderro) === 1){
                                    ...
                                    if(parseInt(NumDia) === parseInt(document.getElementById("guardaNumDiaSemana").value)){
                                        $("#faixaagenda").load("modulos/claviculario/agChave1.php?largTela="+LargTela);
                                    }
                                }
                            }
                ...
                $.confirm({
                    ...
                    buttons: {
                        Sim: function () {
                            ajaxIni();
                            if(ajax){
                                ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=marcaChaveTodas&param="+Valor+"&usuario="+document.getElementById("configselecSolicitante").value, true);
                                ajax.onreadystatechange = function(){
                                    if(ajax.readyState === 4 ){
                                        if(ajax.responseText){
//alert(ajax.responseText);
                ...
                $.confirm({
                    ...
                    buttons: {
                        Sim: function () {
                            ajaxIni();
                            if(ajax){
                                ajax.open("POST", "modulos/claviculario/salvaChave.php?acao=apagaretiradaChave&codigo="+Cod+"&idchaves="+IdChaves, true);
                                ajax.onreadystatechange = function(){
                                    if(ajax.readyState === 4 ){
                                        if(ajax.responseText){
//alert(ajax.responseText);
    ...
    <body class="corClara" onbeforeunload="return mudaTema(0)"> <!-- ao sair retorna os background claros -->
        <?php
        if(!$Conec){
            echo "Sem contato com os arquivos. Informe à ATI.";
            return false;
        }
...
//        pg_query($Conec, "DROP TABLE IF EXISTS ".$xProj.".chaves_agd");
        ...
        $rs = pg_query($Conec, "SELECT chavenum FROM ".$xProj.".chaves LIMIT 1 ");
        $row = pg_num_rows($rs);
        if($row == 0){
...
//        pg_query($Conec, "DROP TABLE IF EXISTS ".$xProj.".chaves_aut");
        pg_query($Conec, "CREATE TABLE IF NOT EXISTS ".$xProj.".chaves_aut (
            id SERIAL PRIMARY KEY, 
            chaves_id integer NOT NULL DEFAULT 0,
...
//______________________
        ...
        FROM ".$xProj.".chaves_ctl GROUP BY TO_CHAR(datasaida, 'MM'), TO_CHAR(datasaida, 'YYYY') ORDER BY TO_CHAR(datasaida, 'YYYY') DESC, TO_CHAR(datasaida, 'MM') DESC ");
        $OpcoesEscAnoMov = pg_query($Conec, "SELECT EXTRACT(YEAR FROM ".$xProj.".chaves_ctl.datasaida)::text 
        FROM ".$xProj.".chaves_ctl GROUP BY 1 ORDER BY 1 DESC ");
        ...
        <div id="tricoluna0" style="margin: 10px; padding: 10px; border: 2px solid; border-radius: 10px; min-height: 52px;">
            ...
            <div id="tricoluna2" class="box" style="position: relative; float: left; width: 55%; text-align: center;">
                <h5><img src="imagens/Chave.png" height="30px;" style="padding-right: 20px; padding-bottom: 5px;" title="Controle de Chaves na Portaria">Controle de Chaves Portaria<img src="imagens/Chave.png" height="30px;" style="padding-left: 20px; padding-bottom: 5px;" title="Controle de Chaves na Portaria"></h5>
            </div>
        ...
        <input type="hidden" id="guardaNumDiaSemana" value="<?php echo $NumDiaSem; ?>" />
        ...
        <div id="registroRetornoChave" class="relacmodal">
            <div class="modal-content-registroChave corPreta">
                ...
                <div style="border: 2px solid blue; border-radius: 10px; background: linear-gradient(180deg, white, #89e9eb)">
                    <table style="margin: 0 auto; width: 85%;">
                        <tr>
                            <td colspan="4" style="text-align: center; padding-top: 5px; font-weight: bold;">Registro de Retorno</td>
                        </tr>
                        <tr>
                            <td colspan="4" style="text-align: center; padding-top: 5px;"></td>
                        </tr>
               ...
               <div style="border: 2px solid blue; border-radius: 10px; margin-top: 10px; text-align: left; background: linear-gradient(180deg, white, #89e9eb)">
                    <table style="margin: 0 auto; width: 85%;">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
<!--                                <label id="voltasolicitante" style="min-width: 200px; padding-left: 3px; font-size: 120%;"></label> -->
                                <input disabled type="text" id="voltasolicitante" style="min-width: 350px; padding-left: 3px; border: 1px solid #666; border-radius: 5px;" onkeypress="if(event.keyCode===13){javascript:foco('voltatelef');return false;}" />
                            </td>
                        </tr>
                        <tr>
                            <td class="etiqAzul">CPF:</td>
        ...
        <div id="modalChavesConfig" class="relacmodal">
            <div class="modal-content-ChavesControle corPreta">
                ...
                <table style="margin: 0 auto; width: 85%;">
                    ...
                    <tr>
                        <td class="etiq" style="border-bottom: 1px solid black;" title="Autorizado a retirar chaves do claviculário da Portaria"></td>
        ...
        <div id="relacimprChaves" class="relacmodal">
            <div class="modal-content-imprChaves corPreta">
                ...
                <h5 style="text-align: center;color: #666;">Controle de Chaves Portaria</h5>
                ...
                <div style="border: 2px solid; border-radius: 10px; padding: 10px; text-align: center;">
                    <input type="button" id="imprRelChave" class="resetbot fundoAzul2" style="font-size: 80%;" value="Relação completa do claviculário da Portaria">
                </div>
        ...
        <div id="modalInfo" class="relacmodal">
            <div class="modal-content-tarjaAzul corPreta" style="text-align: center;">
                ...
                <br>
                <div id="msgInfo6" style="margin-bottom: 40px; color: white; text-align: center;"></div>
            </div>
        </div> <!-- Fim Modal-->
