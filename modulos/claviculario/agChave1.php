...
?>
    <div style="text-align: center; margin: 5px;">
        <h5>Agenda</h5>
        <?php 
        $rs = pg_query($Conec, "SELECT ".$xProj.".chaves_agd.id, chaves_id, chavenum, chavenumcompl, chavesala, TO_CHAR(datasaida, 'DD/MM/YYYY'), usuretira, cpfretira, telef, chavelocal  
            ...
            while($tbl = pg_fetch_row($rs)){
                ...
                <div style="border: 2px solid #CFB53B; border-radius: 8px; padding: 5px;">
                    <table style="margin: 0 auto; width:95%">
                        ...
                        <tr>              
                            <td colspan="2">    
                                <div class="quadrlista" style="text-align: left;"><label class="etiq">Agendada: </label> <?php echo $tbl[5]; ?></div>
                            </td>
                        </tr>
                        <tr>              
                            <td colspan="2">
                        ...
                        <tr>
                            <td colspan="2">
                                <div>
                                    ...
                                    if(strtotime($tbl[5]) == strtotime($Hoje)){
                                        ?>
