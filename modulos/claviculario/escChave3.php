<?php
    ...
    $rsMarc = pg_query($Conec, "SELECT id FROM ".$xProj.".chaves3_aut WHERE pessoas_id = $Usu And ativo = 1");
            ...
            <?php
                if($row > 0){
                    while($tbl = pg_fetch_row($rs)){
                        ...
                        FROM ".$xProj.".chaves3_aut WHERE ativo = 1 And chaves_id = $Cod And pessoas_id = $Usu ");
