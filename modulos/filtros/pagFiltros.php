...
//-------
        ...
        <!-- Tabelas -->
        <div id="container5" style="margin-top 10px; width: 70%; border: 1px solid; border-radius: 15px;"></div>
        <div id="intercolunas" style="width: 1%;"></div> <!-- espaçamento entre colunas  -->
        <div id="container6" style="margin-top 10px; width: 25%; border: 1px solid; border-radius: 15px;"></div>
