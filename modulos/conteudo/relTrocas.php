    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $("#contentPag").load("modulos/conteudo/carTrocas.php?admEdit="+document.getElementById("admEdit").value);
            });
            tinymce.init({
                selector : "textarea",
                language: 'pt_BR',
...
//                menubar: 'edit format table tools',
            ...
            function abreEdit(CodTroca){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/conteudo/salvaTrocas.php?acao=buscaTexto&numero="+CodTroca, true);
...
//alert(ajax.responseText);
            ...
            function salvaTroca(){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/conteudo/salvaTrocas.php?acao=salvaTroca&numero="+document.getElementById("guardaTroca").value+"&texto="+encodeURIComponent(document.getElementById("textotroca").value), true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
            ...
            function apagTroca(){
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/conteudo/salvaTrocas.php?acao=apagaTroca&numero="+document.getElementById("guardaTroca").value, true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
    ...
    <body>
        <?php
            ...
            $admIns = $ProcSis["insAniver"]; // nível para inserir 
