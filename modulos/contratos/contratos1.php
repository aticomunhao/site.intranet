...
//------------------------
        ...
        <div style="margin: 0 auto; justify-content: center; align-items: center;">
            <div style="position: relative; float: left; margin: 5px; text-align: center; width: 48%; border: 1px solid; border-radius: 10px; overflow: auto;"><div id="faixacontatante"></div></div>
