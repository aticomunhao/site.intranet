                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <div class="quadrinho" style="font-size: 80%; text-align: left; border: 0px;" <?php if($Contr == 1){echo "onclick='editContrato(1, $Cod);'";} ?> title="Objeto: <?php echo $tbl[9]; ?>"><?php echo $DescEmpr; ?></div>
                        </td>
                        <td><div class="quadrinho" style="font-size: 70%; text-align: left; border: 0px;" <?php if($Contr == 1){echo "onclick='editContrato(1, $Cod);'";} ?>><?php echo $tbl[9]; ?></div></td>
                        <td>
                            <?php
                            ...
                            ?>
                            <div <?php if($Contr == 1){echo "class='quadrinhoClick' onclick='editContrato(1, $Cod);'";}else{echo "class='quadrinho'";} ?> style="font-size: 70%;"><?php echo $DescSetor; ?></div>
                        </td>
                        <td>
                            <div <?php if($Contr == 1){echo "class='quadrinhoClick' onclick='editContrato(1, $Cod);'";}else{echo "class='quadrinho'";} ?> style="font-size: 70%;" title="Vigência do contrato em meses."><?php echo $tbl[7]; ?></div>
                        </td>
                        <td>
                            <div <?php if($Contr == 1){echo "class='quadrinhoClick' onclick='editContrato(1, $Cod);'";}else{echo "class='quadrinho'";} ?> style="font-size: 70%;" title="Valor do contrato."><?php echo $Valor; ?></div>
                        </td>
                        <td>
                            <?php
                                if($tbl[8] == 0){
