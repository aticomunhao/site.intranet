...
//alert(ajax.responseText);
            ...
            function insContrato(Tipo){
                ...
                document.getElementById("numsequencia").style.visibility = "visible"; 
                if(parseInt(Tipo) === 1){
...
//                                    botApagaBem
            ...
            function editContrato(Tipo, Cod){
                ...
                document.getElementById("numsequencia").style.visibility = "hidden"; 
                document.getElementById("guardaTipo").value = Tipo;
...
//alert(ajax.responseText);
            ...
            function ImprContratosA(Valor){
                if(document.getElementById("indexPor1").checked === true){
                    Index = "dataassinat";
                }else{
                    Index = "datavencim";
                }
                window.open("modulos/contratos/imprContr1.php?acao=listaContratadas&selec="+Valor+"&indexImpr="+Index, "listaContratadas");
            }
...
//                window.open("modulos/contratos/imprContr1.php?acao=listaContratadas", "listaContratadas");
                document.getElementById("relacimprContratosA").style.display = "block";
            }
            function fechaModalImprA(){
                document.getElementById("relacimprContratosA").style.display = "none";
            }
...
//------------------------
        ...
        pg_query($Conec, "UPDATE ".$xProj.".contratos1 SET emvigor = 2 WHERE datavencim <= CURRENT_DATE And emvigor != 3 ");
        ?>
...
<!--                                <select id="selecEmpresa" onchange="modif();" style="font-size: 1rem; min-width: 150px;" title="Selecione uma empresa."></select> -->
        ...
        <div id="relacimprContratosA" class="relacmodal">
            <div class="modal-content-ImprEmpresasA">
                <span class="close" onclick="fechaModalImprA();">&times;</span>
                <h5 id="titulomodal" style="text-align: center;color: #666;">Contratos - Empresas Contratadas</h5>
                ...
                <div style="text-align: center;">
                    ...
                    <table style="margin: 0 auto;">
                        <tr>
                            <td><div style="margin: 5px; padding: 5px; border: 2px solid #C6E2FF; border-radius: 10px;"><button class="resetbot fundoAmareloCl" style="font-size: .9rem;" onclick="ImprContratosA('todos');">Todos</button></div></td>
                            <td><div style="margin: 5px; padding: 5px; border: 2px solid #C6E2FF; border-radius: 10px;"><button class="resetbot fundoAmareloCl" style="font-size: .9rem;" onclick="ImprContratosA('vigor');" title="Contratos em vigor">em Vigor</button></div></td>
                            <td><div style="margin: 5px; padding: 5px; border: 2px solid #C6E2FF; border-radius: 10px;"><button class="resetbot fundoAmareloCl" style="font-size: .9rem;" onclick="ImprContratosA('terminados');" title="Contratos terminados.">Encerrados</button></div></td>
                            <td><div style="margin: 5px; padding: 5px; border: 2px solid #C6E2FF; border-radius: 10px;"><button class="resetbot fundoAmareloCl" style="font-size: .9rem;" onclick="ImprContratosA('rescindidos');" title="Contratos rescindidos.">Rescindidos</button></div></td>
                        </tr>
                    </table>
                </div>
