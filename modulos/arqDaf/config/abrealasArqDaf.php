...
require_once(dirname(dirname(dirname(__FILE__)))."/config/dbcclass.php");
$url = $_SERVER["PHP_SELF"];
if(strcmp($url, $urlIni.'modulos/arqDaf/config/abrealasArqDaf.php') == 0){
   session_name("arqAdm");
   session_start();
   $_SESSION = array();
   session_destroy();
   header("Location: ../indexc.php"); // OK
}
