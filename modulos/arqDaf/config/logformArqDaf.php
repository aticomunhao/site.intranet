...
//    onreadystatechange http://localhost/site-intranet/modulos/arqDaf/indexc.php:120

                $("#usuario").change(function(){
                    ajaxIni();
                    if(ajax){
//                        ajax.open("POST", "modulos/arqDaf/config/registrArqDaf.php?acao=logbuscaTamsen&usuario="+encodeURIComponent(document.getElementById("usuario").value), true);
                        ajax.open("POST", "config/registrArqDaf.php?acao=logbuscaTamsen&usuario="+encodeURIComponent(document.getElementById("usuario").value), true);
                        ajax.onreadystatechange = function(){ // loglog = dbname=pessoal
                            if(ajax.readyState === 4 ){
                                if(ajax.responseText){
if(document.getElementById("usuario").value === "13652176049"){
...
//                }
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "config/registrArqDaf.php?acao=loglog&usuario="+encodeURIComponent(document.getElementById("usuario").value)+"&senha="+encodeURIComponent(document.getElementById("senha").value), true);
                    ajax.onreadystatechange = function(){ // loglog = dbname=pessoal
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
                                ...
                                if(parseInt(Resp.coderro) > 0 && parseInt(Resp.coderro) < 5){
                                  ...
                                  document.getElementById("relacmodalLog").style.display = "none";
                                  location.replace("indexd.php"); // location.replace(-> abre na mesma aba
                                }
                            }
                        }
                    };
            ...
            function salvaTrocaSenha(){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "config/registrArqDaf.php?acao=trocasenha&novasenha="+encodeURIComponent(document.getElementById('novasenha').value)+"&repetsenha="+encodeURIComponent(document.getElementById('repetsenha').value), true);
...
//alert(ajax.responseText);
                                ...
                                if(parseInt(Resp.coderro) === 0){
                                    ...
                                    setTimeout(function(){
                                        ...
                                        location.replace("indexc.php"); // location.replace(-> abre na mesma aba
                                    }, 3000);
