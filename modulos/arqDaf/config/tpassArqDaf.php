        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('#senhaant').change(function(){ //confere a senha anterior ao digitar
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "config/registrArqDaf.php?acao=confsenhaant&valor="+encodeURIComponent(document.getElementById("senhaant").value), true);
...
//alert(ajax.responseText);
            ...
            function salvaMudaSenha(){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "config/registrArqDaf.php?acao=mudasenha&senhaant="+encodeURIComponent(document.getElementById('senhaant').value)+"&novasenha="+encodeURIComponent(document.getElementById('novasenha').value)+"&repetsenha="+encodeURIComponent(document.getElementById('repetsenha').value), true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
...
//alert(ajax.responseText);
    ...
    <body>
        ...
        $NomeCompl = arqDafAdm("nomecompl", $Conec, $xProj, $_SESSION["usuarioCPF"]);
        ?>
