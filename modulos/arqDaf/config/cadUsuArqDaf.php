    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $("#faixacentral").load("config/jUsuArqDaf.php?acao=todos");
            ...
            function carregaModal(id){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "config/registrArqDaf.php?acao=buscausu&numero="+id+"&cpf="+encodeURIComponent(document.getElementById("guardaid_cpf").value), true);
...
//alert(ajax.responseText);
            ...
            function salvaModal(){
                ...
                if(parseInt(document.getElementById("mudou").value) === 1){
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "config/registrArqDaf.php?acao=salvaUsu&numero="+document.getElementById("guardaid_click").value
...
//alert(ajax.responseText);
            ...
            function checaLogin(){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "config/registrArqDaf.php?acao=checaLogin&valor="+encodeURIComponent(document.getElementById("usulogin").value), true);
                    ajax.onreadystatechange = function(){
                        if(ajax.readyState === 4 ){
                            if(ajax.responseText){
//alert(ajax.responseText);
            ...
            function deletaModal(){
                ...
                if(Conf){
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "config/registrArqDaf.php?acao=deletausu&numero="+document.getElementById("guardaid_click").value, true);
                        ajax.onreadystatechange = function(){
                            if(ajax.readyState === 4 ){
                                if(ajax.responseText){
//alert(ajax.responseText);
                ...
                $.confirm({
                    ...
                    buttons: {
                        Sim: function () {
                            ajaxIni();
                            if(ajax){
                                ajax.open("POST", "config/registrArqDaf.php?acao=resetsenha&numero="+encodeURIComponent(document.getElementById("guardaid_cpf").value), true);
                                ajax.onreadystatechange = function(){
                                    if(ajax.readyState === 4 ){
                                        if(ajax.responseText){
//alert(ajax.responseText);
            ...
            function resumoUsu(){
                window.open("modulos/arqDaf/config/imprUsu.php?acao=listaUsuarios", "ListaUsu");
            }
            ...
            function mostraUsu(Valor){
                $("#faixacentral").load("config/jUsuArqDaf.php?acao="+Valor);
            }
