 ...
 * Modificado para incluir nomes com hifens - Picelli, Setembro/2016
 */
class GUtils {
  /**
  ...
  public static function normalizarNome($nome) {
     ...
     */
     $nome = str_replace("\´", "--", $nome);  //Modificado aqui: Modifica os acentos para hifens - PIC
     $nome = str_replace("\`", "--", $nome);  //Modificado aqui: Modifica os acentos para hifens - PIC
     $nome = str_replace("'", "--", $nome);  //Modificado aqui: Modifica os apóstrofos para hifens - PIC
     $nome = str_replace("D`A", "D--A", $nome);  //Modificado aqui: Modifica os acentos para hifens - PIC
     $nome = str_replace("D´A", "D--A", $nome);  //Modificado aqui: Modifica os acentos para hifens - PIC
     $nome = str_replace("D'A", "D--A", $nome);  //Modificado aqui: Modifica os acentos para hifens - PIC
     $nome = str_replace("Sant`An", "Sant--An", $nome);  //Modificado aqui: Modifica os acentos para hifens - PIC
     $nome = str_replace("Sant´An", "Sant--An", $nome);  //Modificado aqui: Modifica os acentos para hifens - PIC
     $nome = str_replace("Sant'An", "Sant--An", $nome);  //Modificado aqui: Modifica os acentos para hifens - PIC
     ...
     * espaço entre elas.
     */
    $partesNome = str_replace("--", "\'", $partesNome);   //Modificado aqui: Retorna hifens para apóstrofo - PIC
