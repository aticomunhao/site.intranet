...
//alert("Versão: "+versaoJquery);

            $(document).ready(function(){
                //Carga inicial
                $('#container1').load('cabecArqDaf.php');
                $('#container2').load('menuinArqDaf.php?diasemana='+document.getElementById('guardadiasemana').value);
    ...
    <body>
        <?php
            ...
            require_once("config/logformArqDaf.php");
        ?>
