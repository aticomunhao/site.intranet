        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $("#configselecSolicitante").change(function(){
                    ...
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/bebedouros/salvaBebed.php?acao=buscausuario&codigo="+document.getElementById("configselecSolicitante").value, true);
...
//alert(ajax.responseText);
                                    ...
                                    if(parseInt(Resp.coderro) === 0){
                                        ...
                                        if(parseInt(Resp.bebed) === 1){
                                            document.getElementById("registrar").checked = true;
                                        }else{
                                            document.getElementById("registrar").checked = false;
                                        }
                                        if(parseInt(Resp.fiscbebed) === 1){
                ...
                $("#configcpfsolicitante").change(function(){
                    ...
                    ajaxIni();
                    if(ajax){
                        ajax.open("POST", "modulos/bebedouros/salvaBebed.php?acao=buscacpfusuario&cpf="+encodeURIComponent(document.getElementById("configcpfsolicitante").value), true);
                        ajax.onreadystatechange = function(){
                            if(ajax.readyState === 4 ){
                                if(ajax.responseText){
//alert(ajax.responseText);
            ...
            function marcaCheckBox(obj, Campo){
                ...
                ajaxIni();
                if(ajax){
                    ajax.open("POST", "modulos/bebedouros/salvaBebed.php?acao=configMarcaCheckBox&codigo="+document.getElementById("configselecSolicitante").value
                    +"&campo="+Campo
                    +"&valor="+Valor
                    , true);
                    ajax.onreadystatechange = function(){
...
//alert(ajax.responseText);
                                ...
                                if(parseInt(Resp.coderro) === 1){
                                    ...
                                    if(parseInt(Resp.coderro) === 2){
                                        ...
                                        $.confirm({
                                            title: 'Ação Suspensa!',
                                            content: 'Não restaria outro marcado para gerenciar os Bebedouros.',
                                            draggable: true,
                                            buttons: {
                                                OK: function(){}
                                            }
    ...
    <body>
        ...
        <div style="margin-top: 15px; padding: 3px; border: 1px solid #666; border-radius: 15px;">
            ...
            <table style="margin: 0 auto; width: 85%;">
                <tr>
                    <td class="etiq80" title="Registrar as trocas dos elementos filtrantes dos Bebedouros">Bebedouros:</td>
                    <td colspan="4">
                        <input type="checkbox" id="registrar" title="Registrar as trocas dos elementos filtrantes dos Bebedouros" onchange="marcaCheckBox(this, 'bebed');" >
                        <label for="registrar" class="etiqNorm" title="Registrar as trocas dos elementos filtrantes dos Bebedouro">Registrar e administrar o funcionamento dos Bebedouros</label>
                    </td>
                </tr>
                <tr>
                    <td class="etiq80" title="Fiscalizar o funcionamento dos Bebedouros">Bebedouros: </td>
                    <td colspan="4">
                        <input type="checkbox" id="fiscalizar" title="Fiscalizar o funcionamento dos Bebedouros" onchange="marcaCheckBox(this, 'bebed_fisc');" >
                        <label for="fiscalizar" class="etiqNorm" title="Fiscalizar o funcionamento dos Bebedouros">Fiscalizar o funcionamento dos Bebedouros</label>
                    </td>
                </tr>
                <tr>
