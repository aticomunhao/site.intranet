...
<html lang="pt-br">
    ...
    <head>
        ...
        <style>
            ...
            .cabec1Dir{
                width: 40%; border: 1px solid blue; border-radius: 20px;
                font-size: 120%;
                font-weight: bold;
                color: white;
                background-color: #6C7AB3; background-image: url('imagens/books_ecassells.jpg' ); 
                background-size: 99% 99%; background-repeat:repeat-x;
            }
    ...
    <body>
        <div id="containerCabec" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 60px;">
            ...
            <div id="container1Cen" class="fontSiteFamily cabec1Cen">
                ...
                $NomeDiaSem = array('Domingo', 'Segunda-feira', 'Terça-feira', 'Quarta-feira', 'Quinta-feira', 'Sexta-feira', 'Sábado');
                $data = date('Y-m-d');
                $diasemana = date('w', strtotime($data));
//                $diasemana = 1;
                ?>
                <div class="fontTrebuchet_Spacing" style="width: 99%; position: absolute; top: 2px; ">Comunhão Espírita de Brasília</div>
                <div class="dataCabec" style="width: 99%; position: absolute;"><?php echo $NomeDiaSem[$diasemana].", ".date('d/m/Y'); ?></div>
            </div>
            <div id="container1Dir" class="cabec1Dir corFundoMenu-dia<?php echo $diasemana; ?>"></div>
        </div>
    </body>
</html>